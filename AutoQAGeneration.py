...
import fitz  
ciq_client = NineBitCIQClient(api_key="901a6f4b-0545-4fdc-b2ed-9a3390ad8889")
cohere_client = CohereClient("qzrDlifnnIwUX9XGTfVwa4kRXd0zMylNTYurqKNO")

# step 1: Extract text from PDF and generate a question

pdf_path = "D:/geo_chap_9.pdf"
...
def get_limited_context(text, char_limit=8500):
